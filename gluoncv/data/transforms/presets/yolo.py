...
class YOLO3DefaultTrainTransform(object):
    ...
    def __init__(self, width, height, net=None, mean=(0.485, 0.456, 0.406),
        ...
        with autograd.train_mode():
            # anchors: (1, 1, 3, 2) * 3, 3 is the feature map level nums
    ...
    def __call__(self, src, label):
        ...
        if self._mixup:
            ...
            gt_mixratio = None
        objectness, center_targets, scale_targets, weights, class_targets, anchor_targets = self._target_generator(
        ...
        return (img, objectness[0], center_targets[0], scale_targets[0], weights[0],
                class_targets[0], anchor_targets[0], gt_bboxes[0])
