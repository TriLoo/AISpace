...
from ...loss import YOLOV3Loss, YOLOV3LossGIoU
...
class YOLOOutputV3(gluon.HybridBlock):
    ...
    def __init__(self, index, num_class, anchors, stride,
        ...
        with self.name_scope():
            ...
            anchors = anchors.reshape(1, 1, -1, 2)          # (1, 1, 9, 2)
        ...
        *args : optional, mxnet.nd.NDArray
        ...
        if autograd.is_training():
            ...
            if autograd.is_recording():
                ...
                all_targets = self._target_generator(box_preds, *args)      # use YOLOV3TargetMerger complete the match of prediction & groundtruth boxes
